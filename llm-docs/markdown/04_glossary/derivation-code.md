...
All crypto material appears in `KERI` in a fully [qualified](https://weboftrust.github.io/WOT-terms/docs/glossary/qualified.md) representation. This includes a derivation code prepended to the crypto-material. ![](https://github.com/WebOfTrust/keri/blob/main/images/derivation-code.png)
